...
fn parse_input() -> HashSet<(i32,i32,i32)> {
  ...
  let mut actives: HashSet<(i32,i32,i32)> = HashSet::new();
  let mut i = 0;
...
fn cycle(actives: HashSet<(i32,i32,i32)>) -> HashSet<(i32,i32,i32)> {
  let mut ping: HashMap<(i32,i32,i32),i32> = HashMap::new();
  ...
  let mut next_cycle: HashSet<(i32,i32,i32)> = HashSet::new();
